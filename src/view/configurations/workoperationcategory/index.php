    ...
    <div class="container-fluid p-0 bg-success">
      ...
      <div class="jumbotron pt-5 bg-white">
            <div class="row m-3 mb-4">
                <h3><i class="fa fa-puzzle-piece" aria-hidden="true"></i> Operation, Cost &amp; Descriptions</h3>
            </div>
            <div class="col-sm-12">
                <div class="row justify-content-end mb-4">
                   <div class="col-sm-9">
                    ...
                    <div class="col-sm-3 text-right">
                      ...
                      <button class="farm-button-icon-button py-1 ml-0 editstaff_index" lang="view/configurations/workoperationcategory">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-4">
                          <label for="wop_code">WOp Code</label>
                              <input type="text" class="form-control" id="wop_code" name="wop_code" value="WOP<?php 
                              $rand = rand(0, 9999);
                              echo str_pad($rand, 4, '0', STR_PAD_LEFT); 
                              ?>"
                                    class="form-control" aria-label="wop_code" aria-describedby="basic-addon1" readonly />
                          
                        </div>
                        <div class="col-sm-4">
                          <label for="no_of_workers">No. of Workers</label>
                              <input type="text" class="form-control" id="no_of_workers" value="" name="no_of_workers" />
                            
                        </div>
                        <div class="col-sm-4">
                          <label for="cost_per_hour">Cost (Per Hour)</label>
                              <input type="text" class="form-control" id="cost_per_hour" value="" name="cost_per_hour" />
...
?>
  ...
  <script>
   function showWorkLocation(perPageCount, pageNumber) {
        $.ajax({
            type: "GET",
            url: "view/configurations/workoperationcategory/select.php",
   ...
   $(document).ready(function(event) {
        ...
        $('.SaveStaff').on('click', function(){
                ...
                //alert(formData)
                    ...
                    $.ajax({
        				url: 'view/configurations/workoperationcategory/insert.php',
        				data: formData,
                        type: 'POST',
