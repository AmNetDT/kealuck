...
<div class="table-responsive data-font" style="height:100%;">
                ...
                <?php
                  ...
                  $user = Db::getInstance()->query("SELECT * FROM job_title ORDER BY id DESC");
                    ...
                    <table id="abdg" class="table table-hover table-bordered" style="width:100%; font-size:0.8rem">
                      <thead>
                        <tr>
                          ...
                          <th style="width:65%; ">Description (KPI)</td>
                          <th>&nbsp;</th>
                        </tr>
                      </thead>
                      <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                  <div class="edit_view" lang="view/configurations/jobtitle" id="<?php echo $user->id; ?>">
       ...
       //singledelete
             ...
             $('.singledelete').on('click', function(){
                ...
                //alert(formData)
                    ...
                    $.ajax({
        				url: 'view/configurations/jobtitle/delete.php',
        				data: formData,
                        type: 'POST',
