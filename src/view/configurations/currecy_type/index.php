                            ...
                            <div class="col-sm-12">
                              ...
                              <div class="row mt-0 mb-3 pt-0">
                                ...
                                ?>
                                     ...
                                     <div class="form-group col-sm-12">
                                         <button type="button" class="btn-danger dete">
                                     <i class="fa fa-trash-o" aria-hidden="true"></i> Delete <i id="currencylabel"></i>
                                     </button>
                                     </div>
                          ...
                          <div class="col-sm-12">
                              <table class="table table-bordered">
                                ...
                                $transaction_year = Db::getInstance()->query("SELECT b.sign, b.name, a.rate, a.date_time FROM `currency_rate` a
                                                        left join currency b on a.currency_id = b.id order by a.id desc limit 3");
                                    	$i = 1;
...
<script>
    $(document).ready(function(event){
		...
		$.ajax({
    			type: "POST",
    			url: 'view/configurations/currecy_type/getcurrency.php',
    			dataType: 'JSON',
    			data: dataString,
    			cache: false,
    			success: function (response) {
     	...
     	$(".dete").on('click', function(){
     	    ...
     	    $.ajax({
        				url: 'view/configurations/currecy_type/delete.php',
        				data: {
                		    ids    : ids
        ...
        $('.SaveStaff').on('click', function(){
                ...
                //alert(formData)
                    ...
                    $.ajax({
        				url: 'view/configurations/currecy_type/insert.php',
        				data: formData,
                        type: 'POST',
        ...
        $('.SaveCurrency').on('click', function(){
                ...
                //alert(formData)
                    ...
                    $.ajax({
        				url: 'view/configurations/currecy_type/insertcurrency_rate.php',
        				data: formData,
                        type: 'POST',
                        contentType: false,  // NEEDED, DON'T OMIT THIS (requires jQuery 1.6+)
                        processData: false, // NEEDED, DON'T OMIT THIS
    	...
    	$('.current_page').click(function (e) {
    		...
    		$.ajax({
    			type: "POST",
    			url: "view/configurations/currecy_type/",
    			cache: false,
    			success: function (msg) {
    				$("#contentbar_inner").html(msg);
    				$("#loader_httpFeed").hide();
    	...
    	$('.view_click').click(function (e) {
    		...
    		$.ajax({
    			type: "POST",
    			url: "view/configurations/currecy_type/view.php",
    			cache: false,
    			success: function (msg) {
    				$("#contentbar_inner").html(msg);
    				$("#loader_httpFeed").hide();
