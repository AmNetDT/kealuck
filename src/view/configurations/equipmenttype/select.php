...
<div class="table-responsive data-font" style="height:100%;">
                ...
                <?php
                  ...
                  $user = Db::getInstance()->query("SELECT a.*, 
                  concat(d.firstname, ' ', lastname) as regitered_by
                  FROM equipmenttype a
                      ...
                      <tbody>
                        ...
                        ?>
                          ...
                          <tr>
                            ...
                            <td><?php echo $user->regitered_by; ?></td>
                            <td>
                                <div class="dropdown">
       ...
       //singledelete
             ...
             $('.singledelete').on('click', function(){
                ...
                //alert(formData)
                    ...
                    $.ajax({
        				url: 'view/configurations/equipmenttype/delete.php',
        				data: formData,
                        type: 'POST',
