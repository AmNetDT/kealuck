        ...
        <!--  offset-md-3 !-->
         ...
         <div id="accounttile" class="container">
            <div class="row justify-content-between mt-5 mb-3">
                    <div class="col-8">
                        <h2>Currency</h2> 
                        <!-- // Remove all characters except digits, plus or minus sign !/-->
                      ...
                      ?>
                        ...
                        <script>
                         <?php $xValues = Db::getInstance()->query("SELECT * FROM `currency_rate` a
                            ...
                            var xValues = [<?php  foreach ($xValues->results() as $xValues) {?><?php function cleanNumber($number) {return preg_replace('/\D/', '', $number); }$phoneNumber = $xValues->date_time;$cleanNumber = cleanNumber($phoneNumber); echo $cleanNumber; ?><?php } ?>];
                          ...
                          <div class="col-sm-12">
                              <table class="table table-bordered">
                                ...
                                $transaction_year = Db::getInstance()->query("SELECT b.sign, b.name, a.rate, a.date_time 
                                                                                ...
                                                                                LEFT JOIN currency b ON a.currency_id = b.id ORDER BY a.date_time DESC");
                                    	$i = 1;
