    ...
    <div id="body_general">
        ...
        <div class="container">
             <?php
                    ...
                    $staffa = Db::getInstance()->query("SELECT CONCAT(sr.firstname,' ', sr.othername,' ',sr.lastname) as staffname, sr.*,
                ...
                <div id="accounttile" class="container">
                    ...
                    <h3 style="line-height:1.0em"><?php echo $staff->staffname ?><br/><span style="font-size:0.9rem;"><?php echo $staff->user_id ?></span></h3>
                                ...
                                <div class="col-3 pl-0"> 
                                    <h2 style="line-height:1.0em">Update <br/><span style="font-size:0.9rem;">Staff</span></h2>
                                </div>
                              </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="container">
                             ...
                             <div class="row justify-content-end mb-3"> 
                                ...
                                <div class="col-3 mx-0 px-0">
                                    ...
                                    <input type="hidden" value="<?php echo $staff->id; ?>" id="id" name="id" />
                                      ...
                                      <button class="farm-button-icon-button py-1 ml-0 current" id="<?php echo $member; ?>">
                            ...
                            <div class="row border-bottom justify-content-center">
                                 ...
                                 <div class="col-12 success_alert"></div>
                                 <div class="col-12 warning_alert"></div>
                                            ...
                                            <div class="col-md-12" style="font-size:0.9rem;">
                                                   ...
                                                   <nav>
                                                      <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                        <a class="nav-link farm-tab-button active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Work Information</a>
                                                        <a class="nav-link farm-tab-button" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Private Information</a>
                                                        <a class="nav-link farm-tab-button" id="nav-kin-tab" data-toggle="tab" href="#nav-kin" role="tab" aria-controls="nav-kin" aria-selected="false">Next of Kin</a>
                                                        <a class="nav-link farm-tab-button" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Hr Settings</a>
                                                      </div>
                                                    </nav>
                                                          ...
                                                          <div class="col-6">
                                                              ...
                                                              <div class="form-row">
                                                                <div class="col-md-6 mb-3">
                                                                  ...
                                                                  <input type="text" class="form-control" id="user_id" name="user_id" value="<?php echo $staff->user_id ?>" disabled>
                                                                </div>
                                                                <div class="col-md-6 mb-3">
                                                                  <label for="syscategory">App Login Privilege</label>
                                                                  <p class="card-text"><small class="text-muted"><?php echo $staff->syscategory ?></small></p>
                                                                </div>
                                                              </div>
                                                           ...
                                                           <div class="col-6" style="border-left:solid 1px #999">
                                                              ...
                                                              <!-- Right Pane !-->
                                                              <input id="memberid" name="memberid" type="hidden" value="<?php echo $member ?>"/>
                                                           </div> 
                                                          </div>
                                                    </div>
                                                    </div>
    ...
    $(document).ready(function(event) {
         ...
         $('.SaveStaff').on('click', function(){
                ...
                //alert(formData)
                    ...
                    $.ajax({
        				url: 'view/usermanager/staff/update.php',
        				data: formData,
                        type: 'POST',
