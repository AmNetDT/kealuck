                                        ...
                                        $payroll_statement = Db::getInstance()->query("SELECT a.*, b.level,
                                            ...
                                            <div class="col-xl-6 col-sm-6 mb-xl-0 pt-5 mb-4">
                                                ...
                                                <table id="deptview" class="table table-hover table-bordered text-right" style="width:100%; font-size:0.8rem">
                                                            ...
                                                            <tr align='right'>
                                                                <td><b>Pension</b></td>
                                                                  <td><?php 
                                                                         ...
                                                                         $Tpension = number_format($pension);
                                                                         echo '-' . $Tpension;
                                                                    ...
                                                                    if($job_level_gross > $total_payments){
                                                                        ?>
                                                                                      ...
                                                                                      <td class="text-danger"><?php 
                                                                                       $Tpenalty = number_format($penalty);
                                                                                            echo '-' . $Tpenalty;
                                                                                             ?></td>
                                                                        <?php
                                                                        ...
                                                                        ?>
                                                                                      ...
                                                                                      <td class="text-success"><?php 
                                                                                            ...
                                                                                            $top = $total_payments - $job_level_gross;
                                                                                            $Ttop = number_format($top);
                                                                                            echo '+' . $Ttop;
                                                                                             ?></td>
                                                                        <?php
                                                                    }
                                                     ...
                                                     $deduction = $pension + $penalty + $paye;
                                                     $Tdeduction = number_format($deduction);
                                                     echo $Tdeduction;
                                                    ...
                                                    ?></td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <p<?php echo $payroll_statement->remarks; ?></p>
                                                                </td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
                                            ...
                                            <div class="col-xl-6 col-sm-6 mb-xl-0 mb-4">
                                                <h2>Gross Salary: NGN <?php 
                                                
                                                     $Tjob_level_gross = number_format($job_level_gross);
                                                echo $Tjob_level_gross; 
                                                ...
                                                <h3>Net Salary: NGN <?php 
                                                
                                                    $tototal = $job_level_gross - $deduction;
                                                     $Ttototal = number_format($tototal);
                                                        echo $Ttototal; 
                                                 ...
                                                 <?php
                                                                        ...
                                                                        $deduct = $pension + $paye;
                                                                        $bonus = $total_payments - $job_level_gross;
                                                                        ?>
                                                                        
                                                <h3>Net Salary: NGN <?php $net = ($job_level_gross - $deduct) + $bonus;
                                                                                $Tnet = number_format($net);
                                                                                echo $Tnet;
                                                                                ?></h3>
