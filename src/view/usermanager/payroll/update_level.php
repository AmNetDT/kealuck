                 ...
                 <div class="row">
                     <div class="col-md-6">
                        <div class="form-group">
                         ...
                         <input type="text" name="total_payments" value="<?php echo $use->total_payments; ?>" id="total_payments" name="total_payments" class="form-control" readonly />
                         </div>
                     </div>
                     </div>
                     <div class="col-md-6">
                        <div class="form-group">
                         ...
                         <div class="input-group mb-2">
                         <input type="text" name="total_payments" value="<?php echo $use->level; ?>" id="total_payments" name="total_payments" class="form-control"  />
                         </div>
                     </div>
                     </div>
                 </div>
