...
?>
                     ...
                     <table id="selectuserabduganiu" class="table table-hover table-bordered" style="width:100%; font-size:0.8em;">
                      <thead>
                        <tr>
                          ...
                          <th class="text-right pr-3" style="width:7%;">Total Amount</th>
  ...
  <?php
        ...
        ?>
                ...
                <div class="table-responsive" style="height: 120%;">
                      <div class="row justify-content-between">
                             <div class="col-sm-12 success_alert" id="success_alert"></div> 
                             <div class="warning_alert" id="warning_alert"></div>
                        </div>
                ...
                ?>
                    ...
                    <table id="selectuserabduganiu" class="table table-hover table-bordered" style="font-size:0.8em;">
                      <thead>
                        <tr>
                          <th style="width:1%;" class="text-center" >S/No</th>
                          <th style="width:7%;">Item Code</th>
...
<?php
  ...
  <script>
        ...
        $(document).ready(function(event){
            	...
            	$(".delete").on('click', function(){
             	   ...
             	   if (confirm("Are you sure you want to remove this item?") == true) {
             	    ...
             	    $.ajax({
                				url: 'view/sales/order-voucher/delete.php',
                				data: {
                        		    ids    : ids
    	...
    	$('.view_voucher').click(function (e) {
    		...
    		$.ajax({
    			type: "POST",
    			url: "view/sales/order-voucher/voucher.php",
    			data: {
    				'member_id': member_id
    			},
    			cache: false,
