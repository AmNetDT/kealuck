      ...
      <div class="jumbotron jumbotron-fluid pt-5 bg-white">
        <div id="accounttile" class="container">
            ...
            foreach ($users->results() as $use) {
                              ...
                              $customer_code = $use->supplier_code;
            ?>
            <div class="row my-3 mb-4 justify-content-between">
                <div class="col-sm-6">
                       <h3>Update Supplier: <?php echo $customer_code; ?></h3>     
                  </div>  
                   <div class="col-sm-2">
             ...
             <form id="uploadForm" method="post" enctype="multipart/form-data">
                             ...
                             <div class="row justify-content-end mb-3"> 
                                ...
                                <div class="col-3 mx-0 px-0">
                                      <button class="farm-button-cancel py-1 ml-0 prev_page" lang="view/purchases/suppliers" id="<?php echo $member_id ?>">
                                        <span class="fa fa-chevron-left"></span>
                                      </button> 
                                      <button type="button" class="farm-button py-1 ml-0 SaveStaff">
                                        <span class="fa fa-save"> Save</span>
                                      </button>
                                      <button class="farm-button-icon-button py-1 ml-0 current_page" lang="view/purchases/suppliers" id="<?php echo $member_id ?>">
                        ...
                        <label for="name">Supplier</label>
                         ...
                         <div class="input-group-prepend"> 
                          <div class="input-group-text">Description</div>
                           ...
                           <input type="text" class="form-control" name="name" value="<?php echo $use->name; ?>" id="name"  />
                         </div>
                     </div>
                        <div class="form-group col-sm-3">
                         <label for="supplier_code">Supplier Code</label>
                         <input type="text" class="form-control" name="supplier_code" value="<?php echo $customer_code; ?>" id="supplier_code" readonly />   
                        </div>
                         <div class="form-group col-sm-3">
    ...
    $(document).ready(function(event){
        ...
        $('.SaveStaff').on('click', function(){
                ...
                //alert(formData)
                    ...
                    $.ajax({
        				url: 'view/purchases/suppliers/update.php',
        				data: formData,
                        type: 'POST',
