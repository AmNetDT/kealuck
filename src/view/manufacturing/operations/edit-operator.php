...
?>
        ...
        <div id="accounttile" class="container">
            ...
            <div class="jumbotron bg-white">
                ...
                <div class="row justify-content-between">
                    <div class="col-sm-9">
                        <h3><i class="fa fa-edit p-1" aria-hidden="true"></i> Update Operator</h3>
                        </div>
                        <div class="col-sm-3">
          ...
          <div class="row my-3">
            <div class="col-sm-12">
                ...
                <?php
                      ...
                      <form id="edit-operation" name="edit-operation" method="post">
                          <div class="modal-body">
                                <div class="row justify-content-between">
                                  ...
                                  <select class="custom-select" id="workoperation_description_id" name="workoperation_description_id">
                                    <option value="<?php echo $usoperator->id; ?>"><?php echo $usoperator->description; ?></option>
                                    <?php
                                    ...
                                    <div class="col-4">
                                        <input type="text" name="wop_code" id="wop_code" class="form-control" value="<?php echo $usoperator->wop_code; ?>" readonly />
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="text" name="description_operation" id="description_operation" value="<?php echo $usoperator->description; ?>" class="form-control" readonly />
                                </div>
                                  <div class="col-4">
                                    <label for="cost_per_hour">Cost per hour</label>
                                    <input type="text" name="cost_per_hour" id="cost_per_hour" value="<?php echo $usoperator->cost_per_hour; ?>" class="form-control" readonly />
                                </div>
                                <div class="col-4">
                                    <label for="duration_in_hour">Hour</label>
                                    <input type="number" name="duration_in_hour" id="duration_in_hour" value="<?php echo $usoperator->duration_in_hour; ?>" class="form-control" />
                                </div>
                                </div>
                                <div class="row justify-content-between my-3">
                                    <div class="col-6">
                                        ...
                                        <input type="text" name="estimated_cost" id="estimated_cost" value="<?php echo $usoperator->estimated_cost; ?>" class="form-control" readonly />
                                      </div>
                                    </div>
                                    <div class="col-6">
                                         <div class="input-group mb-3">
                                              ...
                                              <select class="custom-select" id="assign_to" name="assign_to">
                                                <option value="<?php echo $usoperator->assign_to; ?>"><?php echo $usoperator->assign_to; ?></option>
                                                <?php
                                ...
                                <div class="row justify-content-between my-3"> 
                                    ...
                                    <textarea class="form-control" id="additional_info" name="additional_info"><?php echo $usoperator->additional_info; ?></textarea>
                                    </div>
                                </div>
                                <input type="hidden" name="woperator_id" id="woperator_id" value="<?php echo $usoperator->id; ?>" />
                                <input type="hidden" name="workorders_id" id="workorders_id" value="<?php echo $member_id; ?>" />
                          </div>
                          <div class="modal-footer">
                            <button type="button" class="farm-button py-1 ml-0 Update-Operation">
  ...
  <script>
   $(document).ready(function(event) {
        ...
        $('.Update-Operation').on('click', function(){
       
                let form = $('#edit-operation')[0]; // You need to use standard javascript object here
                let formData = new FormData(form);  
                
                //alert(formData)
           
                    $.ajax({
        				url: 'view/manufacturing/operations/update-operation.php',
        				data: formData,
                        type: 'POST',
